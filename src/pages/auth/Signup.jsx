...
import { Eye, EyeOff, Mail, Lock, User, DollarSign, Loader2, ArrowRight, BarChart2, PieChart, TrendingUp } from 'lucide-react';
...
const Signup = () => {
  ...
  const handleRegister = (data) => {
    setLoading(true);
    dispatch(registerUser({ first_name: data.firstName, email: data.email, password: data.password }))
      .unwrap()
      .then(() => {
        setLoading(false);
        ...
        <div className='hidden lg:flex lg:w-[45%] bg-gradient-to-br from-slate-900 via-slate-800 to-emerald-950 flex-col justify-between p-10 relative overflow-hidden'>
          ...
          <div className='relative'>
            ...
            <p className='text-slate-400 leading-relaxed mb-8'>
              Join thousands of people who have taken control of their finances. It&apos;s free, and always will be.
            </p>

            <div className='space-y-3'>
              {[
                { icon: BarChart2, label: 'Track every dollar you earn & spend' },
                { icon: PieChart, label: 'Understand your spending habits' },
                { icon: TrendingUp, label: 'Build a budget that actually works' },
              ].map(({ icon: Icon, label }) => (
        ...
        <div className='flex-1 flex items-center justify-center bg-slate-50 px-6 py-12'>
          <div className='w-full max-w-md'>
            ...
            <div className='mb-8'>
              ...
              <p className='text-slate-500'>Get started free — no credit card needed</p>
            </div>
            ...
            <div className='bg-white rounded-2xl shadow-card border border-slate-100 p-6 md:p-8'>
              <form className='space-y-4' onSubmit={handleSubmit(handleRegister)}>
                ...
                <button
                  type='submit'
                  disabled={!name || !email || !isPasswordValid || loading}
